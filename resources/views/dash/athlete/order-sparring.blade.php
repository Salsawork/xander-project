@extends('app')
@section('title', 'Sparring Dashboard - Order')
                ...
                <table class="w-full text-left text-gray-300 border-collapse">
                    <thead class="bg-[#292929] text-sm font-normal">
                        <tr>
                            ...
                            <th class="px-4 py-3">Status Sparring</th>
                    ...
                    <tbody class="text-sm font-normal">
                        ...
                        <tr class="border-b border-gray-700">
                            ...
                            <td class="px-4 py-3">
                                ...
                                @endphp
                                <span
                                    class="{{ $statusClass[$order->orderSparrings->first()->schedule->is_booked ?? '0'] ?? 'bg-gray-500 text-white' }} px-3 py-1 rounded-full inline-block min-w-[80px] text-center">
                                    {{ ucfirst($order->orderSparrings->first()->schedule->is_booked ? 'Booked' : 'Pending') }}
                                </span>
                            </td>
                            <td>
                                @if ($order->file)
