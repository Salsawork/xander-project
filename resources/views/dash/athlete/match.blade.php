        ...
        <main class="flex-1 overflow-y-auto min-w-0 mb-8">
            ...
            <div class="p-8 mt-12 mx-20">
                ...
                <div class="flex flex-row justify-between items-center mb-4">
                    <input type="text" placeholder="Search" class="bg-neutral-800 rounded px-4 py-2 w-64 text-white focus:outline-none focus:ring-2 focus:ring-blue-500"/>
                    <div class="flex gap-2">
                        <select class="bg-neutral-800 rounded px-3 py-2 text-white focus:outline-none">
                            <option>Status</option>
                            <option value="pending">Pending</option>
                            <option value="completed">Completed</option>
                            <option value="cancelled">Cancelled</option>
                        </select>
                        <input type="text" placeholder="Date Range" class="bg-neutral-800 rounded px-3 py-2 text-white focus:outline-none"/>
                    </div>
                </div>
                <div class="bg-[#232323] rounded-lg shadow-md overflow-x-auto">
                    <table class="min-w-full text-sm">
                        ...
                        <tbody>
                                ...
                                <tr class="border-b border-neutral-800 hover:bg-neutral-800/50 transition">
                                    ...
                                    <td class="py-3 px-6">
                                        <a href="{{ route('athlete.match.show', $match->id) }}">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 opacity-60 hover:opacity-100 cursor-pointer">
                            ...
                            @empty
                                <tr>
                                    <td colspan="7" class="text-center py-8 text-neutral-400">Belum ada match history.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
