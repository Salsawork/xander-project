        ...
        <div class="flex flex-1 min-h-0">
            ...
            <main class="flex-1 overflow-y-auto min-w-0 mb-8 py-8">
                ...
                <div class="flex items-center justify-between px-8 my-8">
                    ...
                    <a href="{{ route('athlete.index') }}" class="flex items-center gap-2 text-blue-400 hover:text-blue-300">
                        <i class="fas fa-arrow-left"></i>
                        <span>Kembali ke daftar athlete</span>
                    </a>
                </div>
                
                <form id="editAthleteForm" action="{{ route('athlete.update', $athlete->id) }}" method="POST" enctype="multipart/form-data" class="px-8">
                    @csrf
                    @method('PUT')
                            ...
                            <div class="bg-[#262626] rounded-lg p-6 space-y-4">
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            class="w-full rounded-md border border-gray-600 bg-[#262626] px-3 py-2 text-sm text-white focus:outline-none focus:ring-1 focus:ring-blue-500"
                                            name="username" id="username" type="email" value="{{ $athlete->user->username }}" />
                                        @error('username')
                                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                        @enderror
                                    </div>
