@extends('app')
@section('title', 'Admin Dashboard - Tambah Guideline')
    ...
    <div class="flex flex-col min-h-screen bg-neutral-900 text-white font-sans">
        <div class="flex flex-1 min-h-0">
            ...
            <main class="flex-1 overflow-y-auto min-w-0 mb-8">
                ...
                <div class="px-8">
                    <form action="{{ route('admin.guidelines.store') }}" method="POST" class="space-y-6" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <textarea name="description" id="description" rows="3" required
                                        class="w-full rounded-md border border-gray-600 bg-transparent px-3 py-2 text-gray-300 placeholder-gray-500 focus:outline-none focus:ring-1 focus:ring-[#999] focus:border-[#999]">{{ old('description') }}</textarea>
                                </div>
                                ...
                                <div>
                                    ...
                                    <select name="category" id="category" required
                                        ...
                                        <option value="INTERMEDIATE" {{ old('category') == 'INTERMEDIATE' ? 'selected' : '' }}>Intermediate</option>
                                        <option value="MASTER" {{ old('category') == 'MASTER' ? 'selected' : '' }}>Master</option>
                                ...
                                <div>
                                    ...
                                    <select name="skill_level" id="skill_level" required
                                        ...
                                        <option value="master" {{ old('skill_level') == 'master' ? 'selected' : '' }}>Master</option>
                                        <option value="general" {{ old('skill_level') == 'general' ? 'selected' : '' }}>General</option>
                                    </select>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="number" name="reading_time_minutes" id="reading_time_minutes" value="{{ old('reading_time_minutes', 5) }}" min="1"
                                        class="w-full rounded-md border border-gray-600 bg-transparent px-3 py-2 text-gray-300 placeholder-gray-500 focus:outline-none focus:ring-1 focus:ring-[#999] focus:border-[#999]">
                                </div>
                            </div>
                            ...
                            <div class="space-y-6">
                                <div>
                                    ...
                                    <div id="image-preview" class="mt-2 hidden">
                                        <img src="" alt="Preview" class="h-32 rounded border border-gray-600">
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <textarea name="content" id="content" rows="12" required
                                        class="w-full rounded-md border border-gray-600 bg-transparent px-3 py-2 text-gray-300 placeholder-gray-500 focus:outline-none focus:ring-1 focus:ring-[#999] focus:border-[#999]">{{ old('content') }}</textarea>
