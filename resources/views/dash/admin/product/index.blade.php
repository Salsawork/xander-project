                ...
                @foreach ($products as $product)
                    <div class="bg-[#1f1f1f] border border-gray-700 rounded-lg p-4 shadow-md">
                        <div class="flex items-center gap-3 mb-3">
                            ...
                            <span class="px-2 py-1 rounded text-xs {{ $product->quantity > 0 ? 'bg-green-500' : 'bg-red-500' }}">
                                {{ $product->quantity > 0 ? 'In Stock' : 'Out of Stock' }}
                            </span>
                        </div>
                        ...
                        <p class="text-sm text-gray-400 mb-1">Price: Rp {{ number_format($product->pricing, 0, ',', '.') }}</p>
