    ...
    <div class="flex flex-col min-h-screen bg-neutral-900 text-white font-sans">
        <div class="flex flex-1 min-h-0">
            ...
            <main class="flex-1 overflow-y-auto min-w-0 mb-8">
                ...
                <h1 class="text-2xl font-bold p-4 sm:p-8 mt-12">Detail Order</h1>
                ...
                <section class="bg-[#292929] rounded-lg p-4 sm:p-6 mx-4 sm:mx-8 mb-8">
                    ...
                    <div class="mt-6 flex justify-end">
                        <a href="{{ route('order.index') }}" class="px-4 py-2 bg-gray-700 hover:bg-gray-600 rounded-md text-sm sm:text-base">
                            Back to Orders
                        </a>
                    </div>
                </section>
