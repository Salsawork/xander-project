                    ...
                    <div class="border-t border-gray-500 pt-4">
                        ...
                        <div class="toggleContent w-full flex items-center gap-2">
                            <input type="number" name="price_min" placeholder="Min" value="{{ request('price_min') }}"
                                class="w-1/2 rounded border border-gray-400 px-2 py-2 text-sm focus:outline-none focus:ring focus:ring-blue-500" />
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        toggles.forEach((btn) => {
            ...
            btn.addEventListener("click", () => {
                ...
                btn.textContent = content.classList.contains("max-h-0") ? "+" : "–";
            });
        });
