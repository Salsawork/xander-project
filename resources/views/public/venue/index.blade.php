                    ...
                    <div class="bg-neutral-800 rounded-xl overflow-hidden shadow-lg flex flex-row items-center p-6 relative">
                        ...
                        <div class="absolute top-6 right-6">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" class="w-7 h-7 text-gray-400 hover:text-blue-500 cursor-pointer">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M17.25 6.75a4.5 4.5 0 00-6.364 0l-.636.637-.636-.637a4.5 4.5 0 00-6.364 6.364l.637.636L12 20.25l7.364-7.364.636-.636a4.5 4.5 0 000-6.364z" />
                            </svg>
                        </div>
                    </div>
                </span>
