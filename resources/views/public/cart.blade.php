<style>
  ...
  #cart{
    ...
    overflow: hidden; /* jaga konten rapi */
  }
  ...
  @media (max-width: 640px){
    ...
    #cart .cart-header{
      ...
      background: #1e1e1f;  /* gunakan warna yang sama */
    ...
    #cart .cart-meta{ font-size: .75rem; }       /* text-xs */
    #cart .cart-price{ font-size: .875rem; }     /* text-sm */
            ...
            <div class="border-t border-gray-800 pt-4">
                <div class="flex justify-between text-white mb-2 cart-total-row">
                    ...
                    <span>
                        @php
                            $total = 0;
                            foreach ($cartProducts as $item) { $total += (int) $item['price']; }
                            foreach ($cartVenues as $item)   { $total += (int) $item['price']; }
                            foreach ($cartSparrings ?? [] as $item) { $total += (int) $item['price']; }
                        @endphp
